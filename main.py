...
from perception.helpers import get_roi_bbox_for_video, extract_pipeline_names, draw_rois_and_wait, stack_images_v4
...
def main():
    ...
    visualization_shm = SharedMessage.create(Config.visualization_memory_name, Config.max_pipe_data_size)
    ...
    while True:
        pipe_data_bytes = visualization_shm.try_read()
...
def setup_dir_for_iteration():
    ...
    video_name = os.path.splitext(Config.video_name)[0]  # Extract the name without the extension
